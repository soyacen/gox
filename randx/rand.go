...
import (
	...
	"github.com/soyacen/gox/conc/poolx"
...
// GetChaCha8 retrieves a ChaCha8 PRNG from the pool or creates a new one if needed.
//
// Returns:
//   - *randv2.Rand: A ChaCha8 PRNG instance
...
//
// Parameters:
//   - r: The PRNG instance to return
func PutChaCha8(r *randv2.Rand) {
	chacha8Pool.Put(r)
}

// GetPCG retrieves a PCG PRNG from the pool or creates a new one if needed.
//
// Returns:
//   - *randv2.Rand: A PCG PRNG instance
...
//
// Returns:
//   - *randv2.Rand: A new ChaCha8 PRNG instance
//   - error: Error if seed generation fails
...
//
// Returns:
//   - *randv2.Rand: A new PCG PRNG instance
//   - error: Error if seed generation fails
...
//
// Returns:
//   - int: A random non-negative integer
func Int() int {
...
//
// Returns:
//   - int: A random integer in [min, max)
func IntRange(min, max int) int {
	return IntN(max-min) + min
}

// Int32 returns a non-negative pseudo-random 32-bit integer.
//
// Returns:
//   - int32: A random non-negative 32-bit integer
func Int32() int32 {
...
//
// Returns:
//   - int32: A random 32-bit integer in [0, n)
...
//
// Returns:
//   - int32: A random 32-bit integer in [min, max)
func Int32Range(min, max int32) int32 {
	return Int32N(max-min) + min
}

// Int64 returns a non-negative pseudo-random 64-bit integer.
//
// Returns:
//   - int64: A random non-negative 64-bit integer
func Int64() int64 {
...
//
// Returns:
//   - int64: A random 64-bit integer in [0, n)
...
//
// Returns:
//   - int64: A random 64-bit integer in [min, max)
...
//
// Returns:
//   - uint: A random unsigned integer in [0, n)
...
//
// Returns:
//   - uint: A random unsigned integer in [min, max)
...
//
// Returns:
//   - uint32: A random 32-bit unsigned integer
func Uint32() uint32 {
...
//
// Returns:
//   - uint32: A random 32-bit unsigned integer in [0, n)
...
//
// Returns:
//   - uint32: A random 32-bit unsigned integer in [min, max)
...
//
// Returns:
//   - uint64: A random 64-bit unsigned integer
func Uint64() uint64 {
...
//
// Returns:
//   - uint64: A random 64-bit unsigned integer in [0, n)
...
//
// Returns:
//   - uint64: A random 64-bit unsigned integer in [min, max)
...
//
// Returns:
//   - float32: A random float32 in [0.0, 1.0)
...
// String generates a random string of the specified length using the provided character set.
//
// Parameters:
